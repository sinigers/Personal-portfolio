...
(function(c, k) { "function" === typeof define && define.amd ? define(["jquery"], function(m) { return k(m, c, c.document, c.Math) }) : "undefined" !== typeof exports ? module.exports = k(require("jquery"), c, c.document, c.Math) : k(jQuery, c, c.document, c.Math) })("undefined" !== typeof window ? window : this, function(c, k, m, p, D) {
    ...
    c.fn.fullpage = function(d) {
        ...
        function Ra(a) {
            a.find(".fp-slides").after('<div class="fp-controlArrow fp-prev"><i class="fa fa-chevron-left"></i></div><div class="fp-controlArrow fp-next"><i class="fa fa-chevron-right"></div>');
